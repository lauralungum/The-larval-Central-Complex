...
The CNS of several 2nd instar larvae were dissected and placed on 1x PBS. The samples were then fixed for 1 hour in 4\% Paraformyldehate, washed (4 x 15 minute washes) and blocked in 5\% Normal Bovine Serum (check brand)


The following primary antibodies were used:
Rabbit anti-HA(1:300); Rat anti-FLAG (1:200) ; Mouse α-Neuroglian (1:50) 

The following secondary antibodies were used: 
AF488 Donkey α-Mouse(1:500); AF594 Donkey α-Rat(1:700); DL549 Goat α-Rabbit(1:800)
