...
\usepackage{booktabs}
\usepackage{minted}
\usepackage{palatino} % pretty font without ligatures: easier copy-paste from PDF to other formats
...
%TODO: check all the cx core, i.e. .d.b

% MISSING Opening paragraph
...
% Table 1 is cited here. Update the legend to indicate this a selected subset of lineages for which there are established correspondences between larva and adult.
% Table 2 not: much later, and updated.
% Table 3 comes much later, as a summary, at the end of the results when discussing inter-neuropil connectivity.
